    ...
    return (
        <>
            <div style={styles} className="mt-24 max-w-screen-xl flex flex-wrap items-center justify-center mx-auto pl-2 pr-2">
                <Link to="../../profile/add-link" className="block m-2 p-6 bg-gray-900 rounded-lg shadow hover:bg-gray-800 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 w-full">
